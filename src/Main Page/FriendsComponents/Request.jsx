...
function Request() {
  ...
  return (
    <div>
      {curFriends.map((x) => (
        <div className="border-2 border-accent p-3 m-2 rounded-xl bg-background shadow-[1px_2px_5px_0px_rgba(165,_39,_255,_0.48)]">
          <div
          ...
          >
            <img
              ...
              className=" h-full"
            />
            <div className="h-full flex flex-col justify-center w-full items-center text-text font-body text-lg">
